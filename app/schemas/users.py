...
class CommonSignUpRequest(BaseModel):
    ...
    phone_unique_id: constr(max_length=100) = Field(None, title="Phone Unique ID", description="The unique identifier for the user's phone")
    # Private attributes
...
class SocialSignUpRequest(CommonSignUpRequest):
    ...
    email_address: EmailStr = Field(None, title="Email Address", description="The user's email address")
    social_platform: SocialPlatform = Field(..., title="Social Platform", description="The social platform used for signing up")
    social_id: str = Field(..., title="Social ID", description="The user's unique identifier on the social platform")
...
SignUpRequest = Union[SocialSignUpRequest, WalletSignUpRequest, SeedImportSignUpRequest]
...
class UpdateUserRequest(BaseModel):
    ...
    personal_website: constr(max_length=100) = Field(None, title="Personal Website", description="The user's personal or professional website")
    twitter_handle: constr(max_length=50) = Field(None, title="Twitter Handle", description="The user's Twitter username")
    reddit_handle: constr(max_length=20) = Field(None, title="Reddit Handle", description="The user's Reddit username")
    github_username: constr(max_length=39) = Field(None, title="GitHub Username", description="The user's GitHub username")
    phone_login_enabled: bool = Field(None, title="Phone Login Enabled", description="Indicates if phone-based login is enabled")
    phone_unique_id: constr(max_length=100) = Field(None, title="Phone Unique ID", description="The unique identifier for the user's phone")
